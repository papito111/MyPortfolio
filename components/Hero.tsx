...
const Hero = () => {
  return (
    ...
    <div>
        ...
        <Spotlight className='top-30 left-full h-[50vh] w-[70vw]  'fill='blue' />
      </div>
        <Spotlight className='-top-10 left-35 h-[30vh] w-[50vw]  'fill='blue' />
    ...
    <div className='flex justify-center'>
      <div className='max-w-[89vw'>
        <h2 className='upeprcase tracking-widest text-s text center mt-10 max-w-80 text-blue-100'>
          Dynamic WebPages
        </h2>
      </div>
    </div>
